...
<head>
    ...
    <title>Editar Concerto - Primavera Sound</title>
    ...
    <style>
        ...
        .btn-orange { background-color: #f4a019; color: white; border: none; font-family: 'Barlow Condensed', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; }
